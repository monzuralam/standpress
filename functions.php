...
function standpress_scripts() {
	...
	wp_enqueue_script( 'accordions', get_template_directory_uri( ) . '/assets/css/accordions.js', array('jquery'), VERSION, true );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri( ) . '/assets/css/bootstrap.min.js', array('jquery'), VERSION, true );
	wp_enqueue_script( 'isotope', get_template_directory_uri( ) . '/assets/css/isotope.js', array('jquery'), VERSION, true );
	wp_enqueue_script( 'owl', get_template_directory_uri( ) . '/assets/css/owl.js', array('jquery'), VERSION, true );
	wp_enqueue_script( 'slick', get_template_directory_uri( ) . '/assets/css/slick.js', array('jquery'), VERSION, true );
	wp_enqueue_script( 'custom', get_template_directory_uri( ) . '/assets/css/custom.js', array('jquery'), VERSION, true );
