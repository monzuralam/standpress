...
function standpress_scripts() {
	...
	wp_enqueue_style( 'accordions', get_template_directory_uri( ) . '/assets/css/accordions.js', array('jquery'), VERSION, true );
	wp_enqueue_style( 'bootstrap', get_template_directory_uri( ) . '/assets/css/bootstrap.min.js', array('jquery'), VERSION, true );
	wp_enqueue_style( 'isotope', get_template_directory_uri( ) . '/assets/css/isotope.js', array('jquery'), VERSION, true );
	wp_enqueue_style( 'owl', get_template_directory_uri( ) . '/assets/css/owl.js', array('jquery'), VERSION, true );
	wp_enqueue_style( 'slick', get_template_directory_uri( ) . '/assets/css/slick.js', array('jquery'), VERSION, true );
	wp_enqueue_style( 'custom', get_template_directory_uri( ) . '/assets/css/custom.js', array('jquery'), VERSION, true );
